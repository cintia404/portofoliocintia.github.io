...
export default function App() {
  const [theme, setTheme] = useState<AestheticTheme>('coquette');
  ...
  return (
    <div className="relative min-h-screen w-full overflow-x-hidden font-sans select-none pb-12">
      ...
      {/* 2. Floating Glassmorphic Header Navigation */}
      ...
      <main className="relative w-full max-w-7xl mx-auto px-4 md:px-6 space-y-12 md:space-y-20 pt-6">
        {/* 3. Hero Section (Greeting, Center Ribbon, Italic Subtitle) */}
        <Hero theme={theme} />
      ...
      {/* 7. Active Music Widget Player (Live HTML5 Lofi Tracks) */}
      <MusicPlayer />
